...
import { EffectCarousel } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/theme.js?v=8527814633967799821665823063";
...
import { timeline as timeline2, inView } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/vendor.min.js?v=68060928108819451641665310746";
...
import { Delegate } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/vendor.min.js?v=68060928108819451641665310746";
...
import { animate, timeline as timeline3, stagger, Delegate as Delegate2 } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/vendor.min.js?v=68060928108819451641665310746";
import { AnimatedDetails, EffectCarousel as EffectCarousel2, Drawer, throttle } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/theme.js?v=8527814633967799821665823063";
...
import { animate as motionAnimate, scroll } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/vendor.min.js?v=68060928108819451641665310746";
...
import { scroll as scroll2, timeline as timeline4, animate as animate2, inView as inView2 } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/vendor.min.js?v=68060928108819451641665310746";
import { imageLoaded, getHeadingKeyframe } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/theme.js?v=8527814633967799821665823063";
...
import { ScrollArea } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/theme.js?v=8527814633967799821665823063";
...
import { animate as animate3, timeline as timeline5, inView as inView3 } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/vendor.min.js?v=68060928108819451641665310746";
import { getHeadingKeyframe as getHeadingKeyframe2, throttle as throttle2 } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/theme.js?v=8527814633967799821665823063";
...
import { animate as animate4, inView as inView4 } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/vendor.min.js?v=68060928108819451641665310746";
...
import { timeline as timeline6, inView as inView5 } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/vendor.min.js?v=68060928108819451641665310746";
...
import { animate as animate5, timeline as timeline7, inView as inView6 } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/vendor.min.js?v=68060928108819451641665310746";
import { imageLoaded as imageLoaded2 } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/theme.js?v=8527814633967799821665823063";
...
import { timeline as timeline8, animate as animate6, stagger as stagger2, inView as inView7 } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/vendor.min.js?v=68060928108819451641665310746";
import { EffectCarousel as EffectCarousel3, imageLoaded as imageLoaded3, getHeadingKeyframe as getHeadingKeyframe3 } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/theme.js?v=8527814633967799821665823063";
...
import { timeline as timeline9, animate as animate7, inView as inView8 } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/vendor.min.js?v=68060928108819451641665310746";
import { EffectCarousel as EffectCarousel4 } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/theme.js?v=8527814633967799821665823063";
...
var ProductRecommendations = class extends HTMLElement {
  ...
  connectedCallback() {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(this._loadRecommendations.bind(this), { timeout: 1500 });
    } else {
  ...
  async _loadRecommendations() {
    ...
    this._isLoaded = true;
    const section = this.closest(".shopify-section"), url = `${Shopify.routes.root}recommendations/products?product_id=${this.getAttribute("product")}&limit=${this.getAttribute("limit") || 4}&section_id=${section.id.replace("shopify-section-", "")}`, response = await fetch(url, { priority: "low" });
...
import { scroll as scroll3, timeline as timeline10, ScrollOffset, inView as inView9 } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/vendor.min.js?v=68060928108819451641665310746";
...
import { animate as motionAnimate2, timeline as timeline11, inView as inView10 } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/vendor.min.js?v=68060928108819451641665310746";
import { EffectCarousel as EffectCarousel5, imageLoaded as imageLoaded4, getHeadingKeyframe as getHeadingKeyframe4 } from "//cdn.shopify.com/s/files/1/0628/0521/3416/t/27/assets/theme.js?v=8527814633967799821665823063";
...
var SlideshowCarousel = class extends EffectCarousel5 {
  ...
  connectedCallback() {
    super.connectedCallback();
    if (this._player) {
      this._player.addEventListener("player:progress", (event) => {
        Array.from(this.querySelectorAll(".slideshow__cursor-ring, .numbered-dots__item svg")).forEach((item) => item.style = `--progress: ${event.detail.progress}`);
      });
    }
  }
  get transitionType() {
